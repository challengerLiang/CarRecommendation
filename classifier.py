...
for line in data:
    if int(line[-1]) < 10000:
        Y.append(0)
    elif int(line[-1]) >= 10000 and int(line[-1]) < 20000:
        Y.append(1)
    elif int(line[-1]) >= 20000 and int(line[-1]) < 30000:
        Y.append(2)
    elif int(line[-1]) >= 30000 and int(line[-1]) < 50000:
        Y.append(3)
    elif int(line[-1]) >= 50000 and int(line[-1]) < 100000:
        Y.append(4)
    else:
        Y.append(5)
    corp = ""
...
train_X = X.transform(trains)
test_X = X.transform(tests)
clf = MultinomialNB().fit(train_X, Y)
predicted = clf.predict(test_X)
predicted_price = []
for price in predicted:
    if price == 0:
        predicted_price.append(np.random.random_integers(2000, 9999))
    elif price == 1:
        predicted_price.append(np.random.random_integers(10000, 19999))
    elif price == 2:
        predicted_price.append(np.random.random_integers(20000, 29999))
    elif price == 3:
        predicted_price.append(np.random.random_integers(30000, 49999))
    elif price == 4:
        predicted_price.append(np.random.random_integers(50000, 99999))
    else:
        predicted_price.append(np.random.random_integers(100000, 200000))

new_data = []
for i in range(len(test)):
    sample = str(test[i][12]) + " $" + str(predicted_price[i])
